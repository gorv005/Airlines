...
public class AdapterTowns extends BaseAdapter {

    private final LayoutInflater mInflater;
    Activity activity;
    ArrayList<Town> citiesSets;


    public AdapterTowns(Activity activity, ArrayList<Town> citiesSets) {
