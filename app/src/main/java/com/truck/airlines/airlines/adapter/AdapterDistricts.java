...
public class AdapterDistricts extends BaseAdapter {

    private final LayoutInflater mInflater;
    Activity activity;
    ArrayList<District> citiesSets;


    public AdapterDistricts(Activity activity, ArrayList<District> citiesSets) {
    ...
    @Override
    public District getItem(int pos) {
